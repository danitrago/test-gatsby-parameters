...
const RegionTemplate = (props: any) => {
  console.log(props);
  ...
  const dataFiltered = data.filter(
    (vacante) =>
      vacante.cat.includes(cat || "") && vacante.mun.includes(props.pageContext.title)
  );
  ...
  return (
    <div>
      ...
      <div style={{ display: "flex" }}>
        ...
        <div>
          <h1>
            Vacantes Disponibles en la Región: {props.pageContext.title}{" "}
